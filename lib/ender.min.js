...
/*!
    ...
    *
    */
!function(b,c,d){typeof a!="undefined"?a.exports=d(b,c):typeof define=="function"&&typeof define.amd=="object"?define(d):c[b]=d(b,c)}("aspectos",this,function(a,b){return function(){var a,b,c,d,e;return a=function(a){return typeof a=="function"},b=function(a){return Object.prototype.toString.call(a)==="[object Array]"},c=function(b,c,d){var e=a(c)?c:b[c];return function(){return d.apply(b||this,arguments),e.apply(b||this,arguments)}},d=function(c,d,e){var f=a(d)?d:c[d];return function(){var a=f.apply(c||this,arguments);return a?e.apply(c||this,Array.prototype.slice.call(arguments).concat(b(a)?a:[a])):e.apply(c||this,Array.prototype.slice.call(arguments))}},e=function(c,d,e){var f=a(d)?d:c[d];return function(a){if(e&&e.length===2){e[0].apply(c||this,arguments);var d=f.apply(c||this,arguments);return d?e[1].apply(c||this,Array.prototype.slice.call(arguments).concat(b(d)?d:[d])):e[1].apply(c||this,Array.prototype.slice.call(arguments))}return f.apply(c||this,arguments)}},{before:c,after:d,around:e}}()}),provide("aspectos",a.exports)}()